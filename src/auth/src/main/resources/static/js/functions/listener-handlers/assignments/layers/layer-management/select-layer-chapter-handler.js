...
const selectLayerChapterListenerHandler = (layer) => {
	deselectTasks();
	const selectionIndicator = domSelector.selectFirstByClass(layer, "selection-indicator");
	selectionIndicator.classList.add("selected");
}

export default selectLayerChapterListenerHandler;
